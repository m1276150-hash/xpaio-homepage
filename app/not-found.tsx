  ...
  return (
    <div className="min-h-screen bg-[#0D1B2A] text-white flex flex-col items-center justify-center p-6 text-center">
      ...
      >
        ...
        <Link href="/">
          {/* onClick을 아예 제거했습니다. Link가 페이지 이동을 완벽히 수행합니다. */}
          <button 
            type="button" 
            className="px-12 py-4 rounded-2xl bg-[#4ECDC4] text-black font-black text-xl hover:bg-[#FFD93D] transition-all cursor-pointer"
          >
            홈으로 돌아가기
          </button>
        </Link>
